...
research.register_lens_gem("Forcirium", "trinium_materials:gem_forcirium")
research.register_lens_gem("Forcirium2", "trinium_materials:gem_imbued_forcirium")
research.register_lens_gem("Diamond", "trinium_materials:gem_diamond")

research.register_lens_metal("Forcirium", "trinium_materials:ingot_forcirium")
