...
local infuser_mb = {
	...
	map = {
		{x = 0, y = -1, z = 2, name = "trinium_research:reflector_glass"},
		...
		{x = 0, y = 0, z = 2, name = "trinium_research:forcillium_lamp"},
		{x = 0, y = 0, z = 1, name = "trinium_research:reflector_glass"},
		{x = 1, y = 0, z = 1, name = "trinium_research:casing"},
		{x = 1, y = 0, z = 2, name = "trinium_research:reflector_glass"},
		{x = 1, y = 0, z = 3, name = "trinium_research:casing"},
		{x = 0, y = 0, z = 3, name = "trinium_research:reflector_glass"},
		{x = -1, y = 0, z = 3, name = "trinium_research:casing"},
		{x = -1, y = 0, z = 2, name = "trinium_research:reflector_glass"},
		{x = -1, y = 0, z = 1, name = "trinium_research:casing"},
		...
		{x = 0, y = 1, z = 2, name = "trinium_research:reflector_glass"},
		{x = 0, y = 1, z = 1, name = "trinium_research:forcillium_lamp"},
		{x = 1, y = 1, z = 1, name = "trinium_research:chassis"},
		{x = 1, y = 1, z = 2, name = "trinium_research:forcillium_lamp"},
		{x = 1, y = 1, z = 3, name = "trinium_research:chassis"},
		{x = 0, y = 1, z = 3, name = "trinium_research:forcillium_lamp"},
		{x = -1, y = 1, z = 3, name = "trinium_research:chassis"},
		{x = -1, y = 1, z = 2, name = "trinium_research:forcillium_lamp"},
		{x = -1, y = 1, z = 1, name = "trinium_research:chassis"},
		{x = -1, y = 1, z = 0, name = "trinium_research:wall"},
		...
		{x = 0, y = 3, z = 2, name = "trinium_research:reflector_glass"},
