...
minetest.register_node("trinium_research:table", {
		...
		for k, v in pairs(fields) do
			...
			if k_split[1] == "research_table" then
				...
				elseif a == "add_aspects" then
					...
					local new_aspect = table.exists(research.aspects, function(v1)
						return (v1.req1 == a1 and v1.req2 == a2) or (v1.req2 == a1 and v1.req1 == a2)
					end)
					if new_aspect then
	...
	on_metadata_inventory_move = function(pos, _, index1, list2, index2, _, player)
		...
		if list2 == "trash" then
			...
			local _, arr = recalculate_light(meta, pn) -- is done is always false
